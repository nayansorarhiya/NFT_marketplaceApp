...
export default function CartItems({ cartItem, popCartData }) {
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', borderRadius: '25px' }}>
                        <Avatar sx={{ borderRadius: '8px' }} width="48" height="48" src={cartItem.imageurl} />
                    </Box>
                    <Box sx={{
                        cursor: 'pointer', position: 'relative', bottom: '20px',
                        right: '10px',
                    }} onClick={() => popCartData(cartItem.uid)}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', mb: 1 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                <Box sx={{ fontSize: '14px' }}>
                                    {ethers.utils.formatEther(cartItem.price)}
                                </Box>
                                <span style={{ display: 'flex' }}>
                                    <img src={eth} />
                                </span>
